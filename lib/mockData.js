...
export const MOCK_CHATS = [
  {
    ...
    recipientNickname: '아이유 콘서트 후기 얘기 중',
    recipientEmoji: '🐥',
    lastMessage: '아이유 콘서트 진짜 레전드였어요 ㅠㅠ 앵앵콜 최고!',
    lastMessageAt: new Date(Date.now() - 10000).toISOString(),
    expiresAt: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(),
    unread: 1,
    messages: [
      { id: 'm1', senderId: '00000000-0000-0000-0000-000000000002', text: '혹시 지난 주 아이유 콘서트 가셨나요?', createdAt: new Date(Date.now() - 60000).toISOString() },
      { id: 'm2', senderId: '00000000-0000-0000-0000-000000000001', text: '네! 첫콘 다녀왔는데 진짜 목 다 쉬었어요 ㅋㅋ', createdAt: new Date(Date.now() - 30000).toISOString() },
      { id: 'm3', senderId: '00000000-0000-0000-0000-000000000002', text: '아이유 콘서트 진짜 레전드였어요 ㅠㅠ 앵앵콜 최고!', createdAt: new Date(Date.now() - 10000).toISOString() },
    ]
  },
  {
    roomId: 'mock-room-2',
    recipientId: '00000000-0000-0000-0000-000000000004',
    recipientNickname: '종료된 대화 예시',
    recipientEmoji: '⌛',
    ...
    unread: 0,
    messages: [
      { id: 'm4', senderId: '00000000-0000-0000-0000-000000000004', text: '즐거운 관람 되셨길 바라요!', createdAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  }
];
